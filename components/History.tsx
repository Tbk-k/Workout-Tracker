...
const History: React.FC<HistoryProps> = ({ workouts, onDelete }) => {
  ...
  return (
    <div className="p-4 md:p-6">
      <h1 className="text-3xl font-bold mb-6 text-cyan-400">Historia Treningów</h1>
        ...
        <div className="space-y-4">
          {sortedWorkouts.map(workout => (
            <div key={workout.id} className="bg-gray-800 rounded-lg shadow-md overflow-hidden">
              <div className="p-4 flex justify-between items-center cursor-pointer" onClick={() => toggleExpand(workout.id)}>
                <div>
