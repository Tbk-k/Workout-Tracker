...
export const DumbbellIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M14.4 14.4 9.6 9.6M18.657 5.343l-1.414-1.414M19.07 19.07l-1.414 1.414M4.929 4.929 3.515 3.515M14.4 9.6l4.243 4.243M9.6 14.4l-4.243-4.243M12 7.5a4.5 4.5 0 0 0-4.5 4.5v0a4.5 4.5 0 0 0 4.5 4.5h0a4.5 4.5 0 0 0 4.5-4.5v0a4.5 4.5 0 0 0-4.5-4.5Z"/>
  </svg>
);
